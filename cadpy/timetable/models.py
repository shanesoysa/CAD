...
class Group(models.Model):
    academic_year_semester = models.ForeignKey(AcademicYearSemester, on_delete=models.CASCADE)
    ...
    def generate_group_id(self):
        group_id = self.academic_year_semester + '.' + self.programme + '.' + self.group_no
        return group_id
    #str not defined
...
class Subgroup(models.Model):
    ...
    def generate_subgroup_id(self):
        sub_group_id = self.group + '.' + self.subgroup_no
        return sub_group_id
    #str not defined        